		...
		return (
			...
			<div id="resume" className="fill-page">
			  <div className="margin-top">
			    ...
			    <div className="cursor-pointer" id="bio"><img src="olin-logo.png" style={width10} /></div>
			    
			    <h1>WHAT I DID <span style={highlight4}>AS A FRESHMAN</span></h1>
			    <h5>SEPTEMBER 2015 - MAY 2016</h5>

			    <div className="cursor-pointer" id="modsim"><img src="modsim.jpg" style={size10} /></div> &emsp; 
			    <div className="cursor-pointer" id="softdes"><img src="softdes.png" style={size10} /></div>
			  </div>
			</div>
		);
	}
